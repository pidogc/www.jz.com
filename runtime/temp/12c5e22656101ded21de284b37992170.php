<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\project\www.shop.com\public/../application/admin\view\auth\list.html";i:1534863018;}*/ ?>
...
<body>
    ...
    <div class="rightinfo">
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr>
                    <input name='auth_id' type='hidden' value="<?php echo $v['auth_id']; ?>">
                    <td>
    ...
    <script type="text/javascript">
        ...
        $("a:contains('删除')").click(function(){
            ...
            $.get("<?php echo url('/admin/auth/del'); ?>",{auth_id:obj.parents('tr').children('input[name=auth_id]').val()},function(result){
            if(result.code==200){
        ...
        function showupd(obj){
            var obj=$(obj);
            var auth_id=obj.parents('tr').children('input[name=auth_id]').val();
             layer.open({
                type: 2,
                //title: 'layer弹层组件官网',
                //fix: false,
                ...
                area: ['1000px', '500px'],
                content: '<?php echo url("/admin/auth/upd"); ?>?auth_id='+auth_id,
