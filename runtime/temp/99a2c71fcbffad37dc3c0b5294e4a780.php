<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\project\www.shop.com\public/../application/admin\view\type\list.html";i:1534861713;}*/ ?>
    ...
    <div class="rightinfo">
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr>
                    <input name='type_id' type='hidden' value="<?php echo $v['type_id']; ?>">
                    <td>
                    ...
                    <td>
                        <a href="javascript:;" class="tablelink" onclick="showattr(this)">查看</a>
    ...
    <script type="text/javascript">
        ...
        function showattr(obj){
            ...
            layer.open({
                ...
                area: ['1000px', '500px'],
                content: '<?php echo url("/admin/type/attrshow"); ?>?type_id='+type_id,
