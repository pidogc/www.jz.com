<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\project\www.shop.com\public/../application/admin\view\user\list.html";i:1534862152;}*/ ?>
...
<body>
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><a href="javascript:;" class="tablelink" onclick="showupd(this)">查看</a> <a href="javascript:;" class="tablelink"> 删除</a></td>
                </tr>
    ...
    <script type="text/javascript">
        ...
        $("a:contains('删除')").click(function(){
            ...
            var obj=$(this);
            $.get("<?php echo url('/admin/user/del'); ?>",{user_id:$("input[name=user_id]").val()},function(result){
            if(result.code==200){
        ...
        function showupd(obj){
           var obj=$(obj);
            var user_id=obj.parents('tr').children('input[name=user_id]').val();
             layer.open({
                type: 2,
                //title: 'layer弹层组件官网',
                //fix: false,
                ...
                area: ['1000px', '500px'],
                content: '<?php echo url("/admin/user/upd"); ?>?user_id='+user_id,
