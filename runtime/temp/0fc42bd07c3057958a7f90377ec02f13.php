<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\project\www.shop.com\public/../application/admin\view\type\add.html";i:1535531501;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            <ul class="forminfo">
                <li>
                    <label>商品类型</label>
                    <input name="type_name" placeholder="请输入商品类型" type="text" class="dfinput" />
                </li>
                <li>
                    <label>备注信息</label>
...
<script>
   $('#btnSubmit').click(function(){
        ...
        $.post("<?php echo url('/admin/type/add'); ?>",data,function(result){
            if(result.code==200){
